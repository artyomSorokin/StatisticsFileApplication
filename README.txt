...
2 Создать в H2 database свою базу
3 Указать в файле resources/config.properties параметры подключения к базе данных
4 Сбилдить проект, запустить по ссылке localhost:8080/fileStatistics
5 Файл логов лежит на D:/logging.txt